...
<div class="page">
  <header class="gnb"><div class="wrap gnb-inner">
    ...
    <nav class="gnb-nav"><a href="/">홈</a><a href="/content">콘텐츠</a><a href="/guide" class="active">실무백과</a><a href="/community/talk">QnA</a><a href="/archive">자료실</a><a href="/calendar">캘린더</a><a href="/finder">정책자금 파인더<i class="gnb-soon">COMING SOON</i></a></nav>
...
function renderHub(base) {
  ...
  const ld = [{
    ...
    name: '실무백과', description: desc, url: canonical,
...
function renderDetail(g, base) {
  ...
  const ld = [{
    ...
    itemListElement: [
      { '@type': 'ListItem', position: 1, name: '홈', item: base + '/' },
      { '@type': 'ListItem', position: 2, name: '실무백과', item: base + '/guide' },
