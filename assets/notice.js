...
(function (global) {
  ...
  function ensure() {
    ...
    overlay.innerHTML =
      ...
      '<nav class="gnb-nav"><a href="/">홈</a><a href="/content">콘텐츠</a><a href="/guide">실무백과</a><a href="/community/talk">QnA</a><a href="/archive">자료실</a><a href="/calendar" class="active">캘린더</a><a href="/finder">정책자금 파인더<i class="gnb-soon">COMING SOON</i></a></nav>' +
      '<span class="gnb-join" data-open-subscribe>메일로 소식 받기</span></div></div>' +
