...
(function () {
  ...
  function build() {
    ...
    modal.innerHTML =
      ...
      '<p style="font-size:13.5px;color:var(--ink-2);line-height:1.6;margin:0 0 14px;">새 콘텐츠·실무 노트·신고 일정 소식을 이메일로 보내 드립니다. 지금은 이메일만 남겨 주세요.</p>' +
      ...
      '<input data-sub-agree type="checkbox" style="accent-color:#2348D6;width:14px;height:14px;">소식 수신에 동의합니다.</label>' +
    ...
    submit.addEventListener('click', function () {
      ...
      if (!agree.checked) { msg.style.color = '#B4322B'; msg.textContent = '수신 동의가 필요합니다.'; return; }
