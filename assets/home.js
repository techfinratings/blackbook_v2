...
(function () {
  ...
  var QA = {
    hot: [
      { cat: '세무', ans: 2, t: '2일 전', q: '관계회사 대여금, 업무무관 가지급금으로 보는 기준이 어디까지인가요?' },
      { cat: '경영', ans: 1, t: '3일 전', q: '런웨이 12개월 남은 시점, 재무팀이 먼저 손대야 할 항목의 우선순위는?' },
      { cat: '세무', ans: 1, t: '1일 전', q: '가업승계 증여세 특례, 사후관리 요건 실무 경험 있으신 분?' },
      { cat: '회계', ans: 1, t: '1일 전', q: '리스 회계처리, 사용권자산 감가 기준 다들 어떻게 잡으세요?' }
    ],
    new: [
      { cat: '실무', ans: 1, t: '5시간 전', q: '결산 마감 일정 관리, 부서별 체크리스트 템플릿 공유 가능?' },
      { cat: '세무', ans: 1, t: '5시간 전', q: '외화환산손익 인식 시점, 결산일 기준 환율 적용이 맞나요?' },
      { cat: '회계', ans: 1, t: '1일 전', q: '개발비 자산화 요건, 내부 프로젝트에서 어디까지 인정받으셨나요?' },
      { cat: '법령', ans: 0, t: '1일 전', q: '중대재해처벌법 적용 사업장, 재무팀이 챙길 항목이 있을까요?' }
    ]
  };
